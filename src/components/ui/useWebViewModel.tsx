                ...
                <Drawer.Content className="fixed bottom-0 left-0 z-50 bg-white dark:bg-[#1e1e1e] h-screen dark:text-white text-black">
                    <div className="flex items-center px-5 gap-2">
                        <Tooltip content={"Back"} relationship="label">
                            <Button icon={<ArrowLeft24Regular />} appearance="subtle" onClick={handleBackButtonClick} />
                        </Tooltip>
                        <div className="border dark:border-[#aaa] px-6 py-1.5 mx-auto my-2 rounded-full shadow-sm dark:text-[#efefef] flex items-center line-clamp-1 gap-2 bg-white/5 dark:bg-black/5">
